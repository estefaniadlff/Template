				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil5"></i> <span>Alumnos</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Alta 	Alumnos">
								<li class="nav-item"><a href="agregaralumno.html" class="nav-link">Alta Alumnos</a></li>
							</ul>
							<ul class="nav nav-group-sub" data-submenu-title="Editar Alumnos">
								<li class="nav-item"><a href="editaralumno.html" class="nav-link">Editar Alumnos</a></li>
							</ul>
							<ul class="nav nav-group-sub" data-submenu-title="Listar Alumnos">
								<li class="nav-item"><a href="listadealumnos.html" class="nav-link">Listar Alumnos</a></li>
							</ul>
							<ul class="nav nav-group-sub" data-submenu-title="Agregar Pago">
								<li class="nav-item"><a href="agregarpago.html" class="nav-link">Agregar Pago</a></li>
							</ul>
						</li>

						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil5"></i> <span>Grupos</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Listar Grupos">
								<li class="nav-item"><a href="listargrupos.html" class="nav-link">Listar Grupos</a></li>
							</ul>
						</li>
						
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil5"></i> <span>Materia</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Listar Materia">
								<li class="nav-item"><a href="listarmateria.html" class="nav-link">Listar Materia</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil5"></i> <span>Profesor</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Listar Profesor">
								<li class="nav-item"><a href="listarprofesor.html" class="nav-link">Listar Profesor</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil5"></i> <span>Tutorias</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Listar Tutoria">
								<li class="nav-item"><a href="listartutorias.html" class="nav-link">Listar Tutorias</a></li>
							</ul>
							<ul class="nav nav-group-sub" data-submenu-title="Agregar Tutoria">
								<li class="nav-item"><a href="agregartutoria.html" class="nav-link">Agregar Tutorias</a></li>
							</ul>
						</li>
						<!-- /main -->
			...
			<div class="navbar navbar-expand-lg navbar-light">
				...
				<div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; 2015 - 2018. <a href="#">Web App</a> by <a href="http://themeforest.net/user/Kopyov" target="_blank">Estefania De La Fuente Flores</a>
					</span>
